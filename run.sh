...
xterm -fg white -bg black -l -lf $logs_directory/federation-manager-${timestamp}.log -T "Federation Manager" -geometry 40x40 -e "export CPSWT_ROOT=`pwd` && mvn exec:java -P FederationManagerExecJava" &
...
xterm -fg green -bg black -l -lf $logs_directory/ABS-${timestamp}.log -T "ABS" -geometry 40x40 -e "java  -Dlog4j.configurationFile=conf/log4j2.xml -jar ABS-0.1.0-SNAPSHOT.jar  -federationId=AV -configFile=conf/ABSConfig.json" &
waitUntilJoined ABS 1

cd $root_directory/AV_generated/AV-java-federates/AV-impl-java/BMS/target
xterm -fg orange -bg black -l -lf $logs_directory/BMS-${timestamp}.log -T "BMS" -geometry 40x40 -e "java  -Dlog4j.configurationFile=conf/log4j2.xml -jar BMS-0.1.0-SNAPSHOT.jar  -federationId=AV -configFile=conf/BMSConfig.json" &
waitUntilJoined BMS 1



cd $root_directory/AV_generated/AV-java-federates/AV-impl-java/VCU/target
xterm -fg cyan -bg black -l -lf $logs_directory/VCU-${timestamp}.log -T "VCU" -geometry 40x40 -e "java  -Dlog4j.configurationFile=conf/log4j2.xml -jar VCU-0.1.0-SNAPSHOT.jar  -federationId=AV -configFile=conf/VCUConfig.json" &
waitUntilJoined VCU 1



cd $root_directory/AV_generated/AV-java-federates/AV-impl-java/MCU/target
xterm -fg red -bg black -l -lf $logs_directory/MCU-${timestamp}.log -T "MCU" -geometry 40x40 -e "java  -Dlog4j.configurationFile=conf/log4j2.xml -jar MCU-0.1.0-SNAPSHOT.jar  -federationId=AV -configFile=conf/MCUConfig.json
" &
...
xterm -fg yellow -bg black -l -lf $logs_directory/Database-${timestamp}.log -T "Database" -geometry 40x40 -e "java -Dlog4j.configurationFile=conf/log4j2.xml -Djava.net.preferIPv4Stack=true -jar Database-0.0.1-SNAPSHOT.jar conf/Database.json" &
